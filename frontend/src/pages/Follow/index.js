...
const Follow = (props) => {
  ...
  const requestFollowing = process.env.REACT_APP_HOST + "/follow/following/" + location.state.no + "/0"
  const requestFollower = process.env.REACT_APP_HOST + "/follow/follower/" + location.state.no + "/0"
